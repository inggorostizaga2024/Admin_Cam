          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                ...
                <th className="p-2">
                  <div className="font-semibold text-center">Dipositivos</div>
                </th>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Uber</div>
                  </div>
                </td>
                <td className="p-2">
                ...
                <td className="p-2">
                  <div className="text-center text-sky-500">Ver</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Airbnb</div>
                  </div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Oficina</div>
                  </div>
                </td>
                <td className="p-2">
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Constructora</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">2</div>
              ...
              <tr>
                <td className="p-2">
                  <div className="flex items-center">
                    ...
                    <div className="text-slate-800">Bodega</div>
                  </div>
                </td>
                <td className="p-2">
